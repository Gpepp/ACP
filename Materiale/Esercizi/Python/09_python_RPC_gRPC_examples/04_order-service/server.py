...
class OrderManagementServicer(order_management_pb2_grpc.OrderManagementServicer): 
    ...
    def getOrder(self, request, context):
        ...
        if order is not None: 
            ...
            # Error handling 
            print('[OrderManagementServicer] getOrder: Order not found ' + request.value)
    ...
    def searchOrders(self, request, context):  
        print('[OrderManagementServicer] searchOrders: searching for orders with item equal to: ' + request.value)
    ...
    def processOrders(self, request_iterator, context):
        ...
        print('[OrderManagementServicer] processOrders: processing orders for shipping...')
